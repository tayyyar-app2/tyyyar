...
//  سعداوي= =====
  ...
  // فن وطرب==
  // سوكرادورف/////
   {id: 738, brand: 'Chicken Factor', category: 'الوجبات الفردية', n: 'وجبة الأطفال', p: 99, d: '1 قطعة ديوس + 1 قطعة استربس + 1 خبز', img: '🖼️'},
...
{id: 785, brand: 'Chicken Factor', category: 'وجبات الأجنحة والدبابيس', n: 'استربس فاميلي 20', p: 850, d: '20 قطعة استربس + 10 خبز + كول سلو + ثومية + بطاطس + كاتشب', img: './img'},
  ...
  // سوكرادورف/////
  {id: 786, brand: 'El-Thawra', category: 'كريب فراخ', n: 'كريب ميكس جبن', p: 70, d: 'خليط جبن كريب + كاتشب + مايونيز', img: './img'},
{id: 787, brand: 'El-Thawra', category: 'كريب فراخ', n: 'كريب بطاطس', p: 95, d: 'خليط جبن كريب + بطاطس + كاتشب + مايونيز + زيتون', img: './img'},
{id: 788, brand: 'El-Thawra', category: 'كريب فراخ', n: 'كريب استربس', p: 175, d: 'خليط جبن كريب + كاتشب + مايونيز + استربس', img: './img'},
{id: 789, brand: 'El-Thawra', category: 'كريب فراخ', n: 'كريب استربس فريش', p: 125, d: 'خليط جبن كريب + كاتشب + مايونيز + استربس فريش', img: './img'},
{id: 790, brand: 'El-Thawra', category: 'كريب فراخ', n: 'كريب بانيه', p: 110, d: 'خليط جبن كريب + كاتشب + مايونيز + بانيه', img: './img'},
{id: 791, brand: 'El-Thawra', category: 'كريب فراخ', n: 'كريب شيش', p: 200, d: 'خليط جبن كريب + كاتشب + مايونيز + شيش', img: './img'},
{id: 792, brand: 'El-Thawra', category: 'كريب فراخ', n: 'كريب شيش فريش', p: 150, d: 'خليط جبن كريب + كاتشب + مايونيز + شيش فريش', img: './img'},
{id: 793, brand: 'El-Thawra', category: 'كريب فراخ', n: 'كريب شاورما فراخ', p: 165, d: 'خليط جبن + صدور الدجاج فريش + كاتشب + مايونيز + فلفل ألوان + زيتون + تومية', img: './img'},
{id: 794, brand: 'El-Thawra', category: 'كريب فراخ', n: 'كريب فاهيتا', p: 165, d: 'خليط جبن كريب + كاتشب + مايونيز + زيتون شرائح + فلفل رومي + صدور فريش + صوص باربكيو', img: './img'},
{id: 795, brand: 'El-Thawra', category: 'كريب فراخ', n: 'كريب سوبر كرانش', p: 160, d: 'خليط جبن كريب + كاتشب + مايونيز + فلفل رومي + بانيه + استربس + أصابع موزاريلا', img: './img'},
{id: 796, brand: 'El-Thawra', category: 'كريب فراخ', n: 'كريب كوردن بلو', p: 170, d: 'خليط جبن كريب + كاتشب + مايونيز + كوردن بلو + صوص شيدر', img: './img'},
{id: 797, brand: 'El-Thawra', category: 'كريب فراخ', n: 'كريب تشيكن رانش', p: 165, d: 'خليط جبن كريب + كاتشب + مايونيز + صدور دجاج فريش + صوص رانش', img: './img'},
{id: 798, brand: 'El-Thawra', category: 'كريب فراخ', n: 'كريب هالينو', p: 140, d: 'خليط جبن كريب + كاتشب + مايونيز + استربس فريش حار + شيش فريش + فلفل هالينو', img: './img'},
{id: 799, brand: 'El-Thawra', category: 'كريب فراخ', n: 'كريب اسكالوب بانيه', p: 130, d: 'خليط جبن كريب + كاتشب + مايونيز + اسكالوب بانيه', img: './img'},
{id: 800, brand: 'El-Thawra', category: 'كريب ميكسات', n: 'كريب سوبر ريم دجاج', p: 165, d: 'خليط جبن كريب + كاتشب + مايونيز + استربس + شاورما دجاج + تركي مدخن + صوص رانش', img: './img'},
{id: 801, brand: 'El-Thawra', category: 'كريب ميكسات', n: 'كريب ميكس استربس شيش', p: 185, d: 'خليط جبن كريب + كاتشب + مايونيز + استربس + شيش', img: './img'},
{id: 802, brand: 'El-Thawra', category: 'كريب ميكسات', n: 'كريب سكلانس شطبوط', p: 145, d: 'خليط جبن كريب + كاتشب + مايونيز + زيتون شرائح + استربس فريش + بيف بيكون + شيش فريش + صوص تكساك + فلفل اخضر حار', img: './img'},
{id: 803, brand: 'El-Thawra', category: 'كريب ميكسات', n: 'كريب كوكتيل فراخ حار/بارد', p: 165, d: 'خليط جبن كريب + كاتشب + مايونيز + بانيه + استربس + شيش + فلفل ألوان', img: './img'},
{id: 804, brand: 'El-Thawra', category: 'كريب ميكسات', n: 'كريب ميكس لحوم', p: 165, d: 'خليط جبن كريب + كاتشب + مايونيز + سجق + كفتة + سويس + شاورما لحم + صوص تكساك', img: './img'},
{id: 805, brand: 'El-Thawra', category: 'كريب ميكسات', n: 'كريب سوبر لحم', p: 180, d: 'خليط جبن كريب + كاتشب + مايونيز + كفتة + دوزر كباب + بسترمة + صوص رانش', img: './img'},
{id: 806, brand: 'El-Thawra', category: 'كريب ميكسات', n: 'كريب رانش سموك حار/بارد', p: 150, d: 'استربس فريش + سلامي + صوص اسموكي رانش + خليط جبن + كاتشب + مايونيز', img: './img'},
{id: 807, brand: 'El-Thawra', category: 'كريب ميكسات', n: 'كريب ميكس الثورة حار/بارد', p: 175, d: 'خليط جبن كريب + كاتشب + مايونيز + استربس + بانيه + شيش + كفتة + سجق + بيف بيكون + صوص شيدر', img: './img'},
{id: 808, brand: 'El-Thawra', category: 'كريب لحوم', n: 'كريب سويسيس', p: 120, d: 'خليط جبن كريب + كاتشب + مايونيز + هوت دوج + بيف بيكون + صوص شيدر', img: './img'},
{id: 809, brand: 'El-Thawra', category: 'كريب لحوم', n: 'كريب سجق', p: 160, d: 'خليط جبن كريب + كاتشب + مايونيز + سجق + صوص شيدر', img: './img'},
{id: 810, brand: 'El-Thawra', category: 'كريب لحوم', n: 'كريب كفتة', p: 180, d: 'خليط جبن كريب + كاتشب + مايونيز + كفتة + صوص تكسااس', img: './img'},
{id: 811, brand: 'El-Thawra', category: 'كريب لحوم', n: 'كريب شاورما لحم', p: 205, d: 'خليط جبن كريب + كاتشب + مايونيز + شاورما لحم + مكعبات طماطم + صوص شيدر', img: './img'},
{id: 812, brand: 'El-Thawra', category: 'كريب لحوم', n: 'كريب دوزر كباب', p: 185, d: 'خليط جبن كريب + كاتشب + مايونيز + دوزر لحم + صوص شيدر', img: './img'},
{id: 813, brand: 'El-Thawra', category: 'كريب سي فود', n: 'كريب جمبري فرايد', p: 320, d: 'خليط جبن كريب + كاتشب + مايونيز + جمبري فرايد + بولونيز', img: './img'},
{id: 814, brand: 'El-Thawra', category: 'كريب سي فود', n: 'كريب جمبري جريل', p: 450, d: 'خليط جبن كريب + كاتشب + مايونيز + جمبري جريل + زيتون شرائح + فلفل ألوان', img: './img'},
{id: 815, brand: 'El-Thawra', category: 'كريب سي فود', n: 'كريب سي فوود فرايد', p: 250, d: 'خليط جبن كريب + كاتشب + مايونيز + سي فوود + كاليماري + جمبري + بولونيز', img: './img'},
{id: 816, brand: 'El-Thawra', category: 'كريب سي فود', n: 'كريب سي فوود جريل', p: 320, d: 'خليط جبن كريب + كاتشب + مايونيز + سي فوود + كاليماري + جمبري + صوص شيدر', img: './img'},
{id: 817, brand: 'El-Thawra', category: 'بيتزا تشيكن', n: 'بيتزا مارجرينا', p: 100, d: 'كيري + صوص بيتزا + موزاريلا', img: './img'},
{id: 818, brand: 'El-Thawra', category: 'بيتزا تشيكن', n: 'بيتزا تشيز لافرز', p: 120, d: 'كيري + صوص بيتزا + صوص شيدر + موزاريلا + ريكفورد + فلفل ألوان + زيتون', img: './img'},
{id: 819, brand: 'El-Thawra', category: 'بيتزا تشيكن', n: 'بيتزا خضار', p: 115, d: 'كيري + صوص بيتزا + موزاريلا + خضار مشكل + مشروم + زيتون', img: './img'},
{id: 820, brand: 'El-Thawra', category: 'بيتزا تشيكن', n: 'بيتزا بانيه رانش', p: 135, d: 'كيري + صوص بيتزا + بانيه + موزاريلا + فلفل ألوان + زيتون + صوص رانش', img: './img'},
{id: 821, brand: 'El-Thawra', category: 'بيتزا تشيكن', n: 'بيتزا تشيكن فريش', p: 160, d: 'كيري + صوص بيتزا + صدور دجاج فريش + موزاريلا + فلفل ألوان + زيتون', img: './img'},
{id: 822, brand: 'El-Thawra', category: 'بيتزا تشيكن', n: 'بيتزا تشيكن رانش', p: 165, d: 'كيري + صوص بيتزا + صدور دجاج فريش + موزاريلا + فلفل ألوان + زيتون + صوص رانش', img: './img'},
{id: 823, brand: 'El-Thawra', category: 'بيتزا تشيكن', n: 'بيتزا ميكس تشيكن حار/بارد', p: 150, d: 'كيري + صوص بيتزا + صدور دجاج فريش + استربس فريش + بانيه + موزاريلا + فلفل ألوان + زيتون', img: './img'},
{id: 824, brand: 'El-Thawra', category: 'بيتزا تشيكن', n: 'بيتزا استربس فريش حار/بارد', p: 145, d: 'كيري + صوص بيتزا + استربس فريش + موزاريلا + فلفل ألوان + زيتون', img: './img'},

{id: 825, brand: 'El-Thawra', category: 'بيتزا تشيكن', n: 'بيتزا تركي', p: 155, d: 'كيري + صوص بيتزا + بيف مدخن + استربس فريش + موزاريلا + فلفل ألوان + زيتون', img: './img'},
{id: 826, brand: 'El-Thawra', category: 'بيتزا تشيكن', n: 'بيتزا باربيكيو دجاج (فاهيتا)', p: 170, d: 'كيري + صوص بيتزا + صدور دجاج فريش + موزاريلا + فلفل ألوان + مشروم + زيتون + صوص باربيكيو', img: './img'},
{id: 827, brand: 'El-Thawra', category: 'بيتزا تشيكن', n: 'بيتزا شيش طاووق', p: 150, d: 'كيري + صوص بيتزا + شيش فريش + موزاريلا + فلفل ألوان + زيتون', img: './img'},
{id: 828, brand: 'El-Thawra', category: 'بيتزا تشيكن', n: 'بيتزا سوبر سوبرريم', p: 160, d: 'كيري + صوص بيتزا + صدور دجاج فريش + بسطرمة + هوت دوج + موزاريلا + فلفل ألوان + زيتون', img: './img'},
{id: 829, brand: 'El-Thawra', category: 'بيتزا تشيكن', n: 'بيتزا شاورما فراخ', p: 165, d: 'كيري + صوص بيتزا + صدور دجاج + موزاريلا + فلفل ألوان + زيتون + صوص ثومية', img: './img'},
{id: 830, brand: 'El-Thawra', category: 'بيتزا تشيكن', n: 'بيتزا الثورة حار/بارد', p: 170, d: 'كيري + صوص بيتزا + موزاريلا + لحمة ساجي + استربس فريش + دوج كباب + فلفل ألوان + زيتون + صوص تكسااس', img: './img'},
{id: 831, brand: 'El-Thawra', category: 'بيتزا تشيكن', n: 'بيتزا رانش سموكي', p: 180, d: 'كيري + صوص بيتزا + سلامي + استربس فريش + موزاريلا + فلفل ألوان + زيتون + صوص رانش سموكي', img: './img'},

{id: 832, brand: 'El-Thawra', category: 'بيتزا بيف', n: 'بيتزا سويس', p: 140, d: 'كيري + صوص بيتزا + هوت دوج + موزاريلا + فلفل ألوان + زيتون + صوص شيدر', img: './img'},
{id: 833, brand: 'El-Thawra', category: 'بيتزا بيف', n: 'بيتزا كفتة', p: 170, d: 'كيري + صوص بيتزا + كفتة + موزاريلا + فلفل ألوان + زيتون', img: './img'},
{id: 834, brand: 'El-Thawra', category: 'بيتزا بيف', n: 'بيتزا سجق', p: 180, d: 'كيري + صوص بيتزا + سجق + موزاريلا + فلفل ألوان + زيتون + صوص شيدر', img: './img'},
{id: 835, brand: 'El-Thawra', category: 'بيتزا بيف', n: 'بيتزا بلونيز', p: 175, d: 'كيري + صوص بيتزا + مفروم + موزاريلا + فلفل ألوان + زيتون + صوص تكسااس', img: './img'},
{id: 836, brand: 'El-Thawra', category: 'بيتزا بيف', n: 'بيتزا بيبروني', p: 140, d: 'كيري + صوص بيتزا + لحم بيبروني + موزاريلا + فلفل ألوان + زيتون', img: './img'},
{id: 837, brand: 'El-Thawra', category: 'بيتزا بيف', n: 'بيتزا ميكس لحوم', p: 175, d: 'كيري + صوص بيتزا + دوج كباب + شاورما لحم + بيبروني + مفروم + موزاريلا + فلفل ألوان + زيتون', img: './img'},
{id: 838, brand: 'El-Thawra', category: 'بيتزا بيف', n: 'بيتزا اسموكد برجر', p: 175, d: 'كيري + صوص بيتزا + برجر لحم مكعبات + بيف بيكون + موزاريلا + فلفل ألوان + زيتون + صوص شيدر', img: './img'},
{id: 839, brand: 'El-Thawra', category: 'بيتزا بيف', n: 'بيتزا فور سيزون', p: 170, d: 'كيري + صوص بيتزا + موزاريلا + لحم بيبروني + دوج كباب + صدور دجاج فريش + استربس فريش + فلفل ألوان + زيتون', img: './img'},

{id: 840, brand: 'El-Thawra', category: 'بيتزا سي فود', n: 'بيتزا جمبري', p: 325, d: 'كيري + صوص بيتزا + موزاريلا + جمبري جريل + فلفل ألوان + زيتون', img: './img'},
{id: 841, brand: 'El-Thawra', category: 'بيتزا سي فود', n: 'بيتزا سي فود', p: 230, d: 'كيري + صوص بيتزا + موزاريلا + فليبة + كاليماري + فلفل ألوان + زيتون + جمبري', img: './img'},
{id: 842, brand: 'El-Thawra', category: 'بيتزا سي فود', n: 'بيتزا تونة', p: 200, d: 'كيري + صوص بيتزا + موزاريلا + تونة + زيتون', img: './img'},
{id: 843, brand: 'El-Thawra', category: 'بيتزا كريب ميكسات', n: 'بيتزا كريب سوبر ريم دجاج', p: 190, d: 'خليط جبن كريب + كاتشب + مايونيز + استربس + شاورما دجاج + تركي مدخن + صوص رانش + خضار', img: './img'},
{id: 844, brand: 'El-Thawra', category: 'بيتزا كريب ميكسات', n: 'بيتزا كريب ميكس استربس شيش', p: 200, d: 'خليط جبن كريب + كاتشب + مايونيز + استربس + شيش + خضار', img: './img'},
{id: 845, brand: 'El-Thawra', category: 'بيتزا كريب ميكسات', n: 'بيتزا كريب كوكتيل فراخ', p: 175, d: 'خليط جبن كريب + كاتشب + مايونيز + بانيه + استربس + شيش + فلفل ألوان + خضار', img: './img'},
{id: 846, brand: 'El-Thawra', category: 'بيتزا كريب ميكسات', n: 'بيتزا كريب ميكس لحوم', p: 180, d: 'خليط جبن كريب + كاتشب + مايونيز + سجق + كفتة + سويس + شاورما لحم + صوص تكسااس + خضار', img: './img'},
{id: 847, brand: 'El-Thawra', category: 'بيتزا كريب ميكسات', n: 'بيتزا كريب سوبر ريم لحم', p: 205, d: 'خليط جبن كريب + كاتشب + مايونيز + كفتة + دوزر كباب + بسطرمة + رانش صوص + خضار', img: './img'},
{id: 848, brand: 'El-Thawra', category: 'بيتزا كريب ميكسات', n: 'بيتزا كريب رانش سموك حار/بارد', p: 190, d: 'استربس فريش + سلامي + صوص اسموكي رانش + خليط جبن + كاتشب + مايونيز + خضار', img: './img'},
{id: 849, brand: 'El-Thawra', category: 'بيتزا كريب ميكسات', n: 'بيتزا كريب ميكس الثورة حار/بارد', p: 190, d: 'خليط جبن كريب + كاتشب + مايونيز + استربس + بانيه + شيش + كفتة + سجق + بيف بيكون + صوص شيدر + خضار', img: './img'},

{id: 850, brand: 'El-Thawra', category: 'بيتزا كريب لحوم', n: 'بيتزا كريب سويس', p: 150, d: 'خليط جبن كريب + كاتشب + مايونيز + هوت دوج + بيف بيكون + صوص تكسااس + خضار', img: './img'},
{id: 851, brand: 'El-Thawra', category: 'بيتزا كريب لحوم', n: 'بيتزا كريب سجق', p: 180, d: 'خليط جبن كريب + كاتشب + مايونيز + سجق + صوص شيدر + خضار', img: './img'},
{id: 852, brand: 'El-Thawra', category: 'بيتزا كريب لحوم', n: 'بيتزا كريب كفتة', p: 195, d: 'خليط جبن كريب + كاتشب + مايونيز + كفتة + صوص تكسااس + خضار', img: './img'},
{id: 853, brand: 'El-Thawra', category: 'بيتزا كريب لحوم', n: 'بيتزا كريب شاورما لحم', p: 210, d: 'خليط جبن كريب + كاتشب + مايونيز + شاورما لحم + فلفل رومي + زيتون شرائح + مكعبات طماطم + صوص شيدر + خضار', img: './img'},
{id: 854, brand: 'El-Thawra', category: 'بيتزا كريب لحوم', n: 'بيتزا كريب دوزر كباب', p: 190, d: 'خليط جبن كريب + كاتشب + مايونيز + دوزر لحم + صوص شيدر + خضار', img: './img'},

{id: 855, brand: 'El-Thawra', category: 'بيتزا كريب فراخ', n: 'بيتزا كريب ميكس جبن', p: null, d: 'خليط جبن كريب + كاتشب + مايونيز + خضار + فلفل ألوان', img: './img'},
{id: 856, brand: 'El-Thawra', category: 'بيتزا كريب فراخ', n: 'بيتزا كريب بطاطس', p: 155, d: 'خليط جبن كريب + بطاطس + كاتشب + مايونيز + فلفل ألوان + زيتون + خضار', img: './img'},
{id: 857, brand: 'El-Thawra', category: 'بيتزا كريب فراخ', n: 'بيتزا كريب استربس', p: 185, d: 'خليط جبن كريب + كاتشب + مايونيز + استربس + خضار', img: './img'},
{id: 858, brand: 'El-Thawra', category: 'بيتزا كريب فراخ', n: 'بيتزا كريب استربس فريش', p: 150, d: 'خليط جبن كريب + كاتشب + مايونيز + استربس فريش + خضار', img: './img'},
{id: 859, brand: 'El-Thawra', category: 'بيتزا كريب فراخ', n: 'بيتزا كريب بانيه', p: 140, d: 'خليط جبن كريب + كاتشب + مايونيز + بانيه + خضار', img: './img'},
{id: 860, brand: 'El-Thawra', category: 'بيتزا كريب فراخ', n: 'بيتزا كريب شيش', p: 210, d: 'خليط جبن كريب + كاتشب + مايونيز + شيش + خضار', img: './img'},
{id: 861, brand: 'El-Thawra', category: 'بيتزا كريب فراخ', n: 'بيتزا كريب شيش فريش', p: 175, d: 'خليط جبن كريب + كاتشب + مايونيز + شيش فريش + خضار', img: './img'},
{id: 862, brand: 'El-Thawra', category: 'بيتزا كريب فراخ', n: 'بيتزا كريب شاورما فراخ', p: 185, d: 'خليط جبن + صدور دجاج فريش + كاتشب + مايونيز + فلفل ألوان + زيتون + ثومية + خضار', img: './img'},
{id: 863, brand: 'El-Thawra', category: 'بيتزا كريب فراخ', n: 'بيتزا كريب فاهيتا', p: 185, d: 'خليط جبن كريب + كاتشب + مايونيز + فلفل ألوان + زيتون + صدور فريش + صوص باربكيو + خضار', img: './img'},
{id: 864, brand: 'El-Thawra', category: 'بيتزا كريب فراخ', n: 'بيتزا كريب سوبر كرانش', p: 175, d: 'خليط جبن كريب + كاتشب + مايونيز + فلفل ألوان + رانش + استربس + أصابع موزاريلا + خضار', img: './img'},
{id: 865, brand: 'El-Thawra', category: 'بيتزا كريب فراخ', n: 'بيتزا كريب كوردن بلو', p: 185, d: 'خليط جبن كريب + كاتشب + مايونيز + كوردن بلو + صوص شيدر + خضار', img: './img'},
{id: 866, brand: 'El-Thawra', category: 'بيتزا كريب فراخ', n: 'بيتزا كريب تشيكن رانش', p: 185, d: 'خليط جبن كريب + كاتشب + مايونيز + صدور دجاج فريش + صوص رانش + خضار', img: './img'},
{id: 867, brand: 'El-Thawra', category: 'بيتزا كريب فراخ', n: 'بيتزا كريب هالينو', p: 175, d: 'خليط جبن كريب + كاتشب + مايونيز + استربس فريش حار + شيش فريش + فلفل هالينو + خضار', img: './img'},
{id: 868, brand: 'El-Thawra', category: 'بيتزا كريب فراخ', n: 'بيتزا كريب اسكالوب بانيه', p: 150, d: 'خليط جبن كريب + كاتشب + مايونيز + اسكالوب بانيه + خضار', img: './img'},

{id: 869, brand: 'El-Thawra', category: 'بيتزا كريب سي فود', n: 'بيتزا كريب جمبري فرايد', p: 310, d: 'خليط جبن كريب + كاتشب + مايونيز + جمبري فرايد + بولوينز + خضار', img: './img'},
{id: 870, brand: 'El-Thawra', category: 'بيتزا كريب سي فود', n: 'بيتزا كريب جمبري جريل', p: 415, d: 'خليط جبن كريب + كاتشب + مايونيز + جمبري جريل + فلفل ألوان + بولوينز + خضار', img: './img'},
{id: 871, brand: 'El-Thawra', category: 'بيتزا كريب سي فود', n: 'بيتزا كريب سي فود فرايد', p: 250, d: 'خليط جبن كريب + كاتشب + مايونيز + سي فود + فلفل ألوان + كاليماري + جمبري + خضار', img: './img'},
{id: 872, brand: 'El-Thawra', category: 'بيتزا كريب سي فود', n: 'بيتزا كريب سي فود جريل', p: 280, d: 'خليط جبن كريب + كاتشب + مايونيز + سي فود + فلفل ألوان + كاليماري + جمبري + خضار', img: './img'},
{id: 873, brand: 'El-Thawra', category: 'بروستد', n: 'لايت بوكس', p: 110, d: '3 قطع استربس + 150 جرام بطاطس + 2 خبز + تومية', img: './img'},
{id: 874, brand: 'El-Thawra', category: 'بروستد', n: 'سوبر لايت بوكس', p: 170, d: '5 قطع استربس + 250 جرام بطاطس + 2 خبز + كول سلو + تومية', img: './img'},
{id: 875, brand: 'El-Thawra', category: 'بروستد', n: 'سناك بوكس', p: 145, d: '2 قطعة بوبس (واحدة كبيرة وواحدة صغيرة) + بطاطس + 2 خبز + تومية', img: './img'},
{id: 876, brand: 'El-Thawra', category: 'بروستد', n: 'تشيكن وينجز', p: 120, d: '3 قطع جناح + بطاطس + 2 خبز', img: './img'},
{id: 877, brand: 'El-Thawra', category: 'بروستد', n: 'دبابيس دجاج', p: 160, d: '3 قطع دبابيس + كول سلو + تومية + بطاطس + 3 خبز', img: './img'},
{id: 878, brand: 'El-Thawra', category: 'بروستد', n: 'ديز بوكس', p: 190, d: 'صدر + 3 دبابيس + جناح + بطاطس + تومية + كول سلو + 3 خبز', img: './img'},
{id: 879, brand: 'El-Thawra', category: 'بروستد', n: 'سوبر ديز بوكس', p: 230, d: 'قطعتين فخذين + كول سلو + جناح + بطاطس + كولسلو + 4 خبز', img: './img'},
{id: 880, brand: 'El-Thawra', category: 'بروستد', n: 'ديز صدر', p: 240, d: '3 قطع صدر + كول سلو + تومية + بطاطس + 3 خبز', img: './img'},
{id: 881, brand: 'El-Thawra', category: 'بروستد', n: 'بوكس الثورة', p: 330, d: '6 قطع (فخذ + 2 صدر + 2 جناح) + كول سلو + 2 تومية + بطاطس + 6 خبز', img: './img'},

{id: 882, brand: 'El-Thawra', category: 'بروستد عائلي', n: 'سوبر بوكس', p: 500, d: '9 قطع بروسند (فرخة كاملة) + 2 كولسلو + 3 تومية + بطاطس كبير', img: './img'},
{id: 883, brand: 'El-Thawra', category: 'بروستد عائلي', n: 'فاميلي ميل', p: 660, d: '12 قطعة بروستد (فرخة كاملة + صدر + فخذ + جناح) + 12 خبز + 3 كولسلو + 2 تومية + 2 بطاطس كبير', img: './img'},
{id: 884, brand: 'El-Thawra', category: 'بروستد عائلي', n: 'وجبة اقتصادية', p: 790, d: '15 قطعة بروستد (فرخة كاملة + صدر + فخذ + جناح) + 2 ديووس + 15 خبز + 4 كولسلو + 4 تومية + 2 بطاطس كبير', img: './img'},
{id: 885, brand: 'El-Thawra', category: 'بروستد عائلي', n: 'سوبر كريسي استربس', p: 360, d: '12 قطع استربس (600 جرام) + 6 خبز + 2 كولسلو + 3 تومية + 1 بطاطس كبير', img: './img'},
{id: 886, brand: 'El-Thawra', category: 'بروستد عائلي', n: 'ميكس الثورة', p: 480, d: '6 قطع بروستد (فخذ + 2 صدر + 2 جناح) + 6 قطع استربس (300 جرام) + بطاطس كبير + 2 كولسلو + 2 تومية', img: './img'},

{id: 887, brand: 'El-Thawra', category: 'وجبات أطفال', n: 'تشيكن كيدز', p: 105, d: 'قطعة فخذ عادي أو دبوس + بطاطس + خبز + هدية', img: './img'},
{id: 888, brand: 'El-Thawra', category: 'وجبات أطفال', n: 'تشيكن استربس', p: 100, d: '2 قطع استربس عادي + بطاطس + خبز + هدية', img: './img'},
{id: 889, brand: 'El-Thawra', category: 'ساندوتش راب', n: 'راب فرايز', p: 60, d: 'خبز تورتيلا + خس + خيار مخلل شرائح + بطاطس + تومية + صوص شيدر + خليط موزاريلا', img: './img'},
{id: 890, brand: 'El-Thawra', category: 'ساندوتش راب', n: 'راب فرايز هالينو', p: 75, d: 'خبز تورتيلا + خس + بطاطس + مايونيز + صوص شيدر + هالينو شرائح + بيف بيكون + خليط موزاريلا', img: './img'},
{id: 891, brand: 'El-Thawra', category: 'ساندوتش راب', n: 'راب كرسبي', p: 100, d: 'خبز تورتيلا + خس + خيار مخلل شرائح + بطاطس + تومية + استربس كرسبي + صوص شيدر + صوص 1000 جزيرة + خليط موزاريلا', img: './img'},
{id: 892, brand: 'El-Thawra', category: 'ساندوتش راب', n: 'راب فاهيتا', p: 95, d: 'خبز تورتيلا + مايونيز + خس + خيار مخلل شرائح + دجاج فريش + خليط فلفل ألوان + بطاطس + زيتون شرائح + باربكيو صوص + صوص شيدر + خليط موزاريلا', img: './img'},
{id: 893, brand: 'El-Thawra', category: 'ساندوتش راب', n: 'راب شيش طاووق', p: 135, d: 'خبز تورتيلا + مايونيز + خس + خيار مخلل شرائح + شيش فريش + بطاطس + صوص شيدر + صوص تكسااس + خليط موزاريلا', img: './img'},
{id: 894, brand: 'El-Thawra', category: 'ساندوتش راب', n: 'راب ميكس تشيكن', p: 115, d: 'خبز تورتيلا + تومية + خس + خيار مخلل شرائح + استربس + شيش طاووق + شريحة رومي مدخن + بطاطس + صوص شيدر + رانش صوص + خليط موزاريلا', img: './img'},
{id: 895, brand: 'El-Thawra', category: 'ساندوتش راب', n: 'راب سموكي لحوم', p: 125, d: 'خبز تورتيلا + مايونيز + خس + دوج كباب + بيبروني + شريحة شاورما لحم + بطاطس + صوص شيدر + صوص تكسااس + خليط موزاريلا', img: './img'},
{id: 896, brand: 'El-Thawra', category: 'ساندوتش راب', n: 'راب تويستر الثورة', p: 125, d: 'خبز تورتيلا + تومية + خس + صدور دجاج فريش + شيش فريش + بطاطس + أصابع موزاريلا + رومي مدخن + رانش + صوص شيدر + خليط موزاريلا', img: './img'},
{id: 897, brand: 'El-Thawra', category: 'ساندوتش راب', n: 'راب رانش سموك', p: 100, d: 'خبز تورتيلا + خس + خيار مخلل + بطاطس + تومية + استربس كرسبي + صوص شيدر + صوص سموكي رانش + خليط موزاريلا', img: './img'},

{id: 898, brand: 'El-Thawra', category: 'ساندوتش فيلر', n: 'فيلر شاورما فراخ', p: 80, d: 'خبز مخلل + خس + طماطم + صوص شيدر + شاورما دجاج + صوص تومية', img: './img'},
{id: 899, brand: 'El-Thawra', category: 'ساندوتش فيلر', n: 'فيلر شاورما لحم', p: 95, d: 'خبز مخلل + خس + شاورما لحم + صوص شيدر + صوص تكسااس', img: './img'},
{id: 900, brand: 'El-Thawra', category: 'ساندوتش فيلر', n: 'فيلر شيش طاووق', p: 100, d: 'خبز مخلل + خس + شيش طاووق فريش + صوص شيدر + صوص رانش', img: './img'},
{id: 901, brand: 'El-Thawra', category: 'ساندوتش فيلر', n: 'فيلر سوبر سوبرريم (حار/بارد)', p: 130, d: 'مايونيز + خيار مخلل + خس + شريحة تركي مدخن + استربس + صوص شيدر + صوص 1000 جزيرة', img: './img'},
{id: 902, brand: 'El-Thawra', category: 'ساندوتش فيلر', n: 'فيلر ميا مطافي', p: 125, d: 'مايونيز + خس + هالينو شرائح + تركي مدخن + استربس حار + صوص شيدر + صوص', img: './img'},
{id: 903, brand: 'El-Thawra', category: 'ساندوتش فيلر', n: 'فيلر رانش اسموك', p: 115, d: 'خس + بيف بيكون + استربس + صوص شيدر + صوص اسموكي رانش + مايونيز', img: './img'},
{id: 904, brand: 'El-Thawra', category: 'ساندوتش فيلر', n: 'فيلر جمبري فرايد', p: 190, d: 'خس + جمبري مقلي + صوص شيدر + صوص رانش', img: './img'},

{id: 905, brand: 'El-Thawra', category: 'تشيكن ساندوتش حار/بارد', n: 'تشيكن برجر سناڤد', p: 95, d: 'مايونيز + خيار مخلل + خس + تشيكن برجر محشو جبنة + صوص شيدر + صوص 1000 جزيرة', img: './img'},
{id: 906, brand: 'El-Thawra', category: 'تشيكن ساندوتش حار/بارد', n: 'تشيكن برجر تكسااس', p: 120, d: 'مايونيز + خيار مخلل + خس + تشيكن برجر محشو جبنة + رومي مدخن + صوص شيدر + صوص تكسااس', img: './img'},
{id: 907, brand: 'El-Thawra', category: 'تشيكن ساندوتش حار/بارد', n: 'فرايد تشيكن', p: 105, d: 'مايونيز + خيار مخلل + خس + صدور دجاج كرسبي + صوص شيدر + صوص 1000 جزيرة', img: './img'},
{id: 908, brand: 'El-Thawra', category: 'تشيكن ساندوتش حار/بارد', n: 'هالينو تشيكن', p: 150, d: 'مايونيز + خيار مخلل + خس + صدور دجاج كرسبي + صوص شيدر + شرائح فلفل هالينو + هوت صوص', img: './img'},
{id: 909, brand: 'El-Thawra', category: 'تشيكن ساندوتش حار/بارد', n: 'تشيكن لافر تشيكن', p: 130, d: 'مايونيز + خيار مخلل + خس + صدور دجاج كرسبي + 2 أصابع موزاريلا + صوص شيدر + سويت تشيلي', img: './img'},
{id: 910, brand: 'El-Thawra', category: 'تشيكن ساندوتش حار/بارد', n: 'سموكي تشيكن', p: 135, d: 'مايونيز + خيار مخلل + خس + شريحة تركي مدخن + صدور دجاج كرسبي + صوص شيدر + صوص تكسااس', img: './img'},
{id: 911, brand: 'El-Thawra', category: 'تشيكن ساندوتش حار/بارد', n: 'تشيكن باربيكيو', p: 130, d: 'مايونيز + خيار مخلل + خس + شريحة تركي مدخن + صدور دجاج كرسبي + صوص شيدر + صوص باربيكيو', img: './img'},
{id: 912, brand: 'El-Thawra', category: 'تشيكن ساندوتش حار/بارد', n: 'تشيكن رانش', p: 120, d: 'مايونيز + خيار مخلل + خس + 2 حلقة بصل + صدور دجاج كرسبي + صوص شيدر + صوص رانش', img: './img'},

{id: 913, brand: 'El-Thawra', category: 'بيف برجر', n: 'كلاسيك برجر', p: 125, d: 'مايونيز + خيار مخلل + شرائح بصل + شرائح طماطم + بيف لحم + صوص شيدر + صوص 1000 جزيرة + خس', img: './img'},
{id: 914, brand: 'El-Thawra', category: 'بيف برجر', n: 'هالينو برجر', p: 125, d: 'مايونيز + خيار مخلل + شرائح بصل + شرائح طماطم + بيف لحم + صوص شيدر + هالينو + صوص + خس', img: './img'},
{id: 915, brand: 'El-Thawra', category: 'بيف برجر', n: 'برجر تشيز لافرز', p: 140, d: 'مايونيز + خيار مخلل + شرائح بصل + شرائح طماطم + بيف برجر لحم + صوص شيدر + 2 أصابع موزاريلا + سويت تشيلي + خس', img: './img'},
{id: 916, brand: 'El-Thawra', category: 'بيف برجر', n: 'برجر كباب', p: 155, d: 'مايونيز + خيار مخلل + شرائح بصل + شرائح طماطم + بيف لحم + صوص شيدر + دوزر كباب + صوص باربيكيو + خس', img: './img'},
{id: 917, brand: 'El-Thawra', category: 'بيف برجر', n: 'مشروم برجر', p: 150, d: 'مايونيز + خيار مخلل + شرائح بصل + بيف لحم + مشروم فريش + خليط جبنة بيتزا + صوص شيدر + خس', img: './img'},
{id: 918, brand: 'El-Thawra', category: 'بيف برجر', n: 'برجر الثورة', p: 160, d: 'مايونيز + خيار مخلل + شرائح طماطم + شرائح بصل + بيف بيكون + بيف برجر لحم + أصابع موزاريلا + حلقات بصل + صوص شيدر + صوص رانش + خس', img: './img'},
{id: 919, brand: 'El-Thawra', category: 'بيف برجر', n: 'برجر بيج تيستي', p: 145, d: 'مايونيز + خيار مخلل + شرائح بصل + شرائح طماطم + بيف لحم + صوص شيدر + بيف بيكون + صوص تكسااس + خس', img: './img'},
{id: 920, brand: 'El-Thawra', category: 'الطواجن', n: 'نيرسكو فراخ', p: 130, d: 'مكرونة + صدور دجاج فريش + مشروم فريش + وايت صوص + خليط موزاريلا', img: './img'},
{id: 921, brand: 'El-Thawra', category: 'الطواجن', n: 'نيرسكو شيش', p: 150, d: 'مكرونة + شيش فريش + مشروم فريش + وايت صوص + خليط موزاريلا', img: './img'},
{id: 922, brand: 'El-Thawra', category: 'الطواجن', n: 'نيرسكو استربس', p: 130, d: 'مكرونة + وايت صوص + مشروم فريش + استربس فريش + خليط موزاريلا', img: './img'},
{id: 923, brand: 'El-Thawra', category: 'الطواجن', n: 'باستا سيج (طاجن)', p: 125, d: 'مكرونة + ريد صوص + ستيك + فلفل ألوان + خليط موزاريلا', img: './img'},
{id: 924, brand: 'El-Thawra', category: 'الطواجن', n: 'باستا الثورة', p: 130, d: 'مكرونة + صدور دجاج فريش + سلامي + وايت صوص + خليط موزاريلا + بشاميل', img: './img'},
{id: 925, brand: 'El-Thawra', category: 'الطواجن', n: 'باستا جمبري', p: 230, d: 'مكرونة + جمبري + وايت صوص + خليط موزاريلا', img: './img'},
{id: 926, brand: 'El-Thawra', category: 'الطواجن', n: 'باستا فواكه البحر', p: 205, d: 'مكرونة + فليّة + كاليماري + وايت صوص + خليط موزاريلا + كابوريا + جمبري', img: './img'},
{id: 927, brand: 'El-Thawra', category: 'الطواجن', n: 'طاجن بشاميل', p: 145, d: 'مكرونة + وايت صوص + لحم مفروم + بشاميل + موزاريلا', img: './img'},

{id: 928, brand: 'El-Thawra', category: 'باستا', n: 'باستا الفريدو', p: 145, d: 'مكرونة + صدور دجاج فريش + مشروم + فلفل ألوان + وايت صوص + عيش دوريتوس', img: './img'},
{id: 929, brand: 'El-Thawra', category: 'باستا', n: 'شاورما فراخ', p: 125, d: 'مكرونة + شاورما فراخ + مشروم + فلفل ألوان + عيش دوريتوس', img: './img'},
{id: 930, brand: 'El-Thawra', category: 'باستا', n: 'لازانيا مفروم', p: 160, d: 'شرائح لحم لازانيا + صوص بلونيز + جبنة موزاريلا + عيش دوريتوس', img: './img'},
{id: 931, brand: 'El-Thawra', category: 'باستا', n: 'باستا بلونيز', p: 175, d: 'مكرونة + صوص بلونيز + ريد صوص + موزاريلا + فلفل ألوان + عيش دوريتوس', img: './img'},
{id: 932, brand: 'El-Thawra', category: 'باستا', n: 'تشيكن فورماتو', p: 205, d: 'صدور دجاج فريش + بطاطس + مكرونة + بشاميل + خليط جبن بيتزا + صوص فورماتو', img: './img'},
{id: 933, brand: 'El-Thawra', category: 'باستا', n: 'مكرونة وايت صوص', p: 65, d: 'مكرونة + وايت صوص', img: './img'},
{id: 934, brand: 'El-Thawra', category: 'باستا', n: 'مكرونة ريد صوص', p: 65, d: 'مكرونة + ريد صوص', img: './img'},

{id: 935, brand: 'El-Thawra', category: 'الوجبات', n: 'بيكاتا', p: 225, d: 'مكرونة + صدور دجاج + صوص جريفي أو صوص وايت صوص + بطاطس + تومية', img: './img'},
{id: 936, brand: 'El-Thawra', category: 'الوجبات', n: 'تشيكن جريل', p: 160, d: 'أرز بسمتي + صدور فراخ + بطاطس + طماطم متبلة', img: './img'},
{id: 937, brand: 'El-Thawra', category: 'الوجبات', n: 'وجبة الثورة', p: 195, d: 'أرز بسمتي + 2 دبابيس كرسبي + استربس كرسبي + شيش فريش + بطاطس + تومية', img: './img'},
{id: 938, brand: 'El-Thawra', category: 'الوجبات', n: 'بيف استيك', p: 260, d: 'أرز مبهر + خضار سوتيه + لحم فيليه + صوص جريفي + بطاطس', img: './img'},
{id: 939, brand: 'El-Thawra', category: 'الوجبات', n: 'وجبة كفتة', p: 205, d: 'أرز بسمتي + كفتة + تومية + بطاطس + طماطم متبلة', img: './img'},
{id: 940, brand: 'El-Thawra', category: 'الوجبات', n: 'ميكس جريل', p: 230, d: 'أرز بسمتي + شيش + ستيك + كفتة + بطاطس + طماطم متبلة', img: './img'},
{id: 941, brand: 'El-Thawra', category: 'الوجبات', n: 'شيش فريش', p: 165, d: 'أرز بسمتي + شيش جريل + بطاطس + طماطم متبلة', img: './img'},
{id: 942, brand: 'El-Thawra', category: 'الوجبات', n: 'اسكالوب بانيه', p: 150, d: 'مكرونة ريد صوص + اسكالوب بانيه + بطاطس', img: './img'},
{id: 943, brand: 'El-Thawra', category: 'الوجبات', n: 'وجبة مسحب كفتة', p: 200, d: 'كفتة + ربع فراخ + أرز بسمتي + بطاطس + طماطم متبلة + تومية — ورك 190 / صدر 200', img: './img'},
{id: 944, brand: 'El-Thawra', category: 'الوجبات', n: 'وجبة مسحب ستيك', p: 200, d: 'ستيك + ربع فراخ + أرز بسمتي + بطاطس + طماطم متبلة + تومية — ورك 190 / صدر 200', img: './img'},
