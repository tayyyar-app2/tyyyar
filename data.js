...
const MENU=[
  ...
  {id: 739, brand: 'Chicken Factor', category: 'الوجبات الفردية', n: 'سناك بوكس', p: 135, d: '2 قطعة دجاج + 2 خبز + كولسلو أو ثومية + بطاطس + كاتشب', img: './img/ف سناك دينر سوبر .jpg'},
  {id: 740, brand: 'Chicken Factor', category: 'الوجبات الفردية', n: 'دينر بوكس', p: 200, d: '3 قطع دجاج + 2 خبز + كولسلو أو ثومية + بطاطس + كاتشب', img: './img/ف سناك دينر سوبر .jpg'},
  {id: 741, brand: 'Chicken Factor', category: 'الوجبات الفردية', n: 'سوبر دينر بوكس', p: 240, d: '4 قطع دجاج + 3 خبز + كولسلو أو ثومية + بطاطس + كاتشب', img: './img/ف سناك دينر سوبر .jpg'},
  ...
  {id: 743, brand: 'Chicken Factor', category: 'الوجبات العائلية', n: 'فاميلي ميل', p: 399, d: '6 قطع دجاج + 4 خبز + كول سلو + ثومية + بطاطس + كاتشب', img: './img/ف فاملي ميل و بوكس.jpg'},
  {id: 744, brand: 'Chicken Factor', category: 'الوجبات العائلية', n: 'فاميلي بوكس', p: 599, d: '9 قطع دجاج + 6 خبز + كول سلو + ثومية + بطاطس + كاتشب', img: './img/ف فاملي ميل و بوكس.jpg'},
  ...
  {id: 748, brand: 'Chicken Factor', category: 'ساندوتشات تشيكن برجر', n: 'باربيكيو تشيكن برجر', p: 110, d: 'قطعة برجر + شرائح جبنة شيدر + صوص الباربيكيو + طماطم + خيار مخلل', img: './img/ف باربيكيوا تشكن.jpg'},
  {id: 749, brand: 'Chicken Factor', category: 'ساندوتشات تشيكن برجر', n: 'رانش تشيكن برجر', p: 110, d: 'قطعة برجر + شرائح جبنة شيدر + صوص الرانش + طماطم + خيار مخلل', img: './img/ف رانش تشكن و تستي تشكن .jpg'},
  {id: 750, brand: 'Chicken Factor', category: 'ساندوتشات تشيكن برجر', n: 'بيج تيستي تشيكن برجر', p: 110, d: 'قطعة برجر + شرائح جبنة شيدر + صوص بيج تيستي + طماطم + خيار مخلل', img: './img/ف رانش تشكن و تستي تشكن .jpg'},
  {id: 751, brand: 'Chicken Factor', category: 'السندوتشات', n: 'تويستر رول', p: 100, d: 'خبز تورتيلا + قطع دجاج مخلية + صوص فاكْتوري + مايونيز + طماطم + خس', img: './img/ف تويستر رول .jpg'},
  {id: 752, brand: 'Chicken Factor', category: 'السندوتشات', n: 'موزاريلا تويستر رول', p: 125, d: 'قطع دجاج مخلية + جبنة موتزاريلا سايحة + موتزاريلا ستيك + صوص فاكْتوري + مايونيز + طماطم + خس + خيار مخلل', img: './img/ف منوريلا توستر رو ل.jpg'},
  {id: 753, brand: 'Chicken Factor', category: 'السندوتشات', n: 'بيج فِلر', p: 135, d: 'قطعة دجاج مخلية + شرائح بيف بيكون مدخن + شرائح جبنة الشيدر + صوص الجبنة الشيدر + صوص بيبر + طماطم + مايونيز', img: './img/ف بيج فيلر.jpg'},
  {id: 754, brand: 'Chicken Factor', category: 'السندوتشات', n: 'تشيكن كلاسي', p: 125, d: 'قطع دجاج مخلية + شريحة جبنة شيدر + مايونيز + صوص فاكْتوري + طماطم + خس + خيار مخلل', img: './img/ف تشكن كلاسك.jpg'},
  {id: 767, brand: 'Chicken Factor', category: 'السندوتشات', n: 'تشيكن تركي', p: 135, d: 'قطعة دجاج مخلية + شرائح تركي مدخن + شريحة جبنة شيدر + مايونيز + صوص فاكْتوري + طماطم + خس + خيار مخلل', img: './img/ف تشكن تركي .jpg'},
  {id: 768, brand: 'Chicken Factor', category: 'السندوتشات', n: 'بيكون فاكْتوري', p: 135, d: 'قطع دجاج مخلية + بيف بيكون مشوي + شريحة جبنة شيدر + مايونيز + صوص فاكْتوري + صوص باربكيو + خبز + خيار مخلل', img: './img/ف بيكون فاكتور .jpg'},
  {id: 769, brand: 'Chicken Factor', category: 'السندوتشات', n: 'موتزاريلا فاكْتوري', p: 135, d: 'قطع دجاج مخلية + موتزاريلا سايحة + موتزاريلا ستيك + شريحة جبنة شيدر + مايونيز + صوص فاكْتوري + طماطم + خس + خيار مخلل', img: './img/ف موتزاريلا فا كتور .jpg'},
  {id: 770, brand: 'Chicken Factor', category: 'السندوتشات', n: 'أونيون فاكْتوري', p: 135, d: 'قطع دجاج مخلية + بصل مكرمل + تركي مدخن + شريحة جبنة شيدر + مايونيز + صوص فاكْتوري + طماطم + خبز + خيار مخلل', img: './img/ف اونيون فاكتور .jpg'},
  {id: 771, brand: 'Chicken Factor', category: 'السندوتشات', n: 'سوبر فاكْتوري', p: 140, d: 'قطع دجاج مخلية + خيار مخلل + موتزاريلا ستيك + بيف بيكون + تركي مدخن + صوص فاكْتوري + صوص هوت بيبر + شيدر + طماطم + خس', img: './img/ف سوبر فاكتور .jpg'},
  {id: 772, brand: 'Chicken Factor', category: 'السندوتشات', n: 'فاكتوري تشيز', p: 135, d: 'قطع دجاج مخلية + شريحة جبنة شيدر + مايونيز + صوص فاكْتوري + طماطم + خبز + خيار مخلل', img: './img/ف فاكتور تشيز.jpg'},
