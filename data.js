...
//  سعداوي= =====
  ...
  // فن وطرب==
  // سوكرادورف/////
{id: 737, brand: 'sokradorf', category: 'بدائل السكر', n: 'سوكرادورف =بديل السكر الابيض', p: 250, d: 'بديل للسكر على شكل نقط تتكون من مادة السكرالوز، العبوة تحتوي على 300 نقطة تكافئ 300 ملعقة سكر ',  img: './img/قطره2.jpeg'},
{id: 738, brand: 'sokradorf', category: 'زبدة المكسرات', n: 'زبدة الفول السوداني الطبيعية', p:105 , d: 'زبدة فول سوداني طبيعية 100% مصنوعة من حبوب الفول السوداني فقط، بدون أي إضافات أو محليات الوزن 300 جرام صافي', img: './img/زبده الفول السوداني.jpeg'},
{id: 739, brand: 'sokradorf', category: 'كريمات المكسرات', n: 'كريمة الفول السوداني بالشوكولاتة', p: 270, d: 'تجمع بين الطعم الغني للفول السوداني وقوامه الكريمي، مع لمسة لذيذة من الشوكولاتة الوزن 300 جرام صافي', img: './img/كريمه فول سوداني شوكلاته.jpeg'},
{id: 740, brand: 'sokradorf', category: 'كريمات المكسرات', n: 'كريمة السمسم', p: 220, d: 'كريمة السمسم الصحية - نفس طعم الحلاوة السبريد بالظبط لكن صحية الوزن 300 جرام صافي',  img: './img/كريمه سمسم.jpeg'},
{id: 741, brand: 'sokradorf', category: 'كريمات المكسرات', n: 'كريمة السمسم بالشوكولاتة', p: 270, d: 'الأولى من نوعها في مصر! تجمع بين النكهة المميزة للسمسم وقوامه الناعم مع لمسة شوكولاتة إسباني الوزن 300 جرام صافي',  img: './img/كريمه سمسم شوكولاته.jpeg'},
{id: 742, brand: 'sokradorf', category: 'زبدة المكسرات', n: 'زبدة الكاجو', p:435 , d: 'مصنوعة من 100% حبوب الكاجو المطحونة فقط بدون أي إضافات أخرى نهائياً الوزن 300 جرام صافي',  img: './img/زبده كاجوا.jpeg'},
{id: 743, brand: 'sokradorf', category: 'زبدة المكسرات', n: 'زبدة الفستق', p: 655, d: 'مصنوعة من 100% فستق مطحون فقط بدون أي زيوت مضافة، بدون سكر، وبدون مواد حافظة الوزن 300 جرام صافي',   img: './img/زبده فستق.jpeg'},
{id: 744, brand: 'sokradorf', category: 'زبدة المكسرات', n: 'زبدة اللوز المحمص', p:395 , d: 'مصنوعة من لوز محمص بعناية ليمنحك طعمًا دافئًا وقوامًا كريميًا ناعمًا الوزن 300 جرام صافي',  img: './img/زبده اللوز.jpeg'},
{id: 745, brand: 'sokradorf', category: 'كريمات المكسرات', n: 'كريمة الفستق', p: 745, d: 'فستق محمص بعناية ليمنحك نكهة طبيعية عميقة وقوامًا كريميًا فاخرًا الوزن 300 جرام صافي',  img: './img/كريمه فستق.jpeg'},
{id: 746, brand: 'sokradorf', category: 'كريمات المكسرات', n: 'كريمة البندق بالشوكولاتة', p:595 , d: 'بندق تركي محمص بعناية مع شوكولاتة إسبانية غنية في كريمة ناعمة الوزن 300 جرام صافي',  img: './img/كريمه بوندق شوكولاته.jpeg'},
{id: 747, brand: 'sokradorf', category: 'كريمات المكسرات', n: 'كريمة البندق', p:545 , d: 'بندق تركي محمص بعناية في كريمة ناعمة بقوام كريمي وطعم لا يُقاوم الوزن 300 جرام صافي',  img: './img/‏‏كريمه بندق - نسخة.jpeg'},
{id: 748, brand: 'sokradorf', category: 'عسل', n: 'عسل زهور الموالح', p: 225, d: 'عسل نحل طبيعي من زهور الموالح (Citrus Honey)، يتميّز برائحته العطرية المنعشة ومذاقه الفريد الذي يجمع بين الحلاوة الخفيفة ولمسة الحمضيات الطبيعية. يُجمع من مصادر موثوقة وخضع لاختبارات دقيقة في معمل Q-CAP التابع لوزارة الزراعة (المعتمد في فحوصات التصدير)، لضمان أعلى مستويات الجودة والنقاء. تم التأكد من: ✅ خلوّه من السكروز ✅ احتوائه على نسبة مياه أقل من 20% ✅ انخفاض قيمة HMF، مما يعني أنه لم يُسخن إطلاقًا للحفاظ على الفيتامينات والمعادن. عسل نقي – مُختبَر – موثوق – بطعم طبيعي منعش غني بالفوائد.', e: '', img: './img/عسل موالح2.jpeg'},
{id: 749, brand: 'sokradorf', category: 'عسل', n: 'عسل سدر', p: 450, d: 'عسل سدر طبيعي فاخر يُعد من أعلى أنواع العسل قيمة غذائية، ويتميّز بتركيز مرتفع من مضادات الأكسدة مقارنة بمعظم أنواع العسل الأخرى. مصدره أشجار السدر، وتم جمعه من مناطق الصعيد، حيث البيئة الطبيعية الأقل تلوثًا، ما ينعكس مباشرة على جودة العسل وقوته. القيمة الأساسية لعسل السدر ترجع إلى مضادات الأكسدة، وهي مركبات تساعد الجسم على مقاومة الشوارد الحرة، وتقليل الإجهاد التأكسدي، ودعم صحة الخلايا والمناعة على المدى الطويل. كلما زادت كثافة العسل ولونه الداكن، دلّ ذلك على ارتفاع محتواه من هذه المركبات النشطة، وهو ما يميّز عسل السدر بشكل واضح. خضع العسل لاختبارات معملية في معمل Q-CAP التابع لوزارة الزراعة، وهو من الجهات المعتمدة التي تُستخدم في فحص منتجات التصدير، لضمان أعلى مستويات الجودة والنقاء. تم التأكد من: ✅ خلوّه من السكروز ✅ احتوائه على نسبة مياه أقل من 20% ✅ انخفاض قيمة HMF، بما يدل على عدم تعرّضه للتسخين والحفاظ على مكوّناته الفعّالة.', e: '', img: './img/عسل سدر2.jpeg'},
{id: 750, brand: 'sokradorf', category: 'عسل', n: 'عسل بالمكسرات', p: 400, d: 'استمتع بمذاق فاخر يجمع بين عسل البرسيم الطبيعي و150 جم من الكاجو واللوز وعين الجمل المحمّص، لتجربة غنية بالطعم والقيمة في كل ملعقة.', e: '', img: './img/عسل مكسرات.jpeg'},
{id: 751, brand: 'sokradorf', category: 'عسل', n: 'عسل حبة البركة', p: 179, d: 'عسل نقي بجودة عالية، يُجمع من رحيق زهور حبة البركة، ليمنحك طعمًا مميزًا وفوائد طبيعية داعمة للمناعة والصحة العامة. منتجاتنا موثوقة خاضعة لاختبارات دقيقة في معمل Q-CAP التابع لوزارة الزراعة (المعتمد في فحوصات التصدير)، لضمان أعلى مستويات الجودة والنقاء. تم التأكد من: ✅ خلوّه من السكروز ✅ احتوائه على نسبة مياه أقل من 20% ✅ انخفاض قيمة HMF، مما يعني أنه لم يُسخن إطلاقًا للحفاظ على الفيتامينات والمعادن. عسل نقي – مُختبَر – موثوق – بطعم طبيعي خفيف يناسب كل يوم.', e: '', img: './img/عسل حبه بركه.jpeg'},
{id: 752, brand: 'sokradorf', category: 'عسل', n: 'عسل زهرة البرسيم', p: 179, d: 'عسل نحل طبيعي من زهور البرسيم (Clover Honey)، يتميّز بطعمه الخفيف ومذاقه المتوازن الذي يناسب جميع الأذواق. منتجاتنا موثوقة خاضعة لاختبارات دقيقة في معمل Q-CAP التابع لوزارة الزراعة (المعتمد في فحوصات التصدير)، لضمان أعلى مستويات الجودة والنقاء. تم التأكد من: ✅ خلوّه من السكروز ✅ احتوائه على نسبة مياه أقل من 20% ✅ انخفاض قيمة HMF، مما يعني أنه لم يُسخن إطلاقًا للحفاظ على الفيتامينات والمعادن. عسل نقي – مُختبَر – موثوق – بطعم طبيعي خفيف يناسب كل يوم.', e: '', img: './img/عسل برسيم.jpeg'},
{id: 753, brand: 'sokradorf', category: 'عسل', n: 'عسل نحل بخلاصة الكركم', p: 300, d: 'عسل طبيعي يُضاف إليه خلاصة الكركم النقية (Turmeric Extract)، المستخلصة من الجزء الفعّال في نبات الكركم، لتعزيز المناعة ودعم صحة المفاصل، خاصة في فصل الشتاء. نستخدم خلاصة مركّزة خالية من الجزيئات الكبيرة غير المرغوبة، لتستفيد من الفوائد الكاملة في كل ملعقة مع الحفاظ على القوام الناعم. خضع لاختبارات في العديد من الجهات الموثوقة أبرزها معمل Q-CAP التابع لوزارة الزراعة (الذي يلجأ له من يريد التصدير) لضمان أعلى مستويات الجودة والنقاء. تم التأكد من: ✅ خلوّه من السكروز ✅ احتوائه على نسبة مياه أقل من 20% ✅ انخفاض قيمة HMF، مما يعني أنه لم يُسخن إطلاقًا للحفاظ على الفيتامينات والمعادن. منتج طبيعي – مُختبَر – موثوق – غني بالفوائد.', e: '', img: './img/عسل كركم 4.webp'},
{id: 754, brand: 'sokradorf', category: 'عسل', n: 'عسل نحل بخلاصة الجنسنغ', p: 300, d: 'عسل طبيعي يُضاف إليه خلاصة الجنسنغ النقية (Ginseng Extract)، المستخلصة من الجزء الفعّال في نبات الجنسنغ، لدعم الطاقة والتركيز وتعزيز الحيوية بشكل طبيعي. نستخدم خلاصة مركّزة خالية من الجزيئات الكبيرة غير المرغوبة، لتستفيد من الفوائد الكاملة في كل ملعقة مع الحفاظ على القوام الناعم والطعم الغني. خضع لاختبارات في العديد من الجهات الموثوقة، أبرزها معمل Q-CAP التابع لوزارة الزراعة (الذي يُعتمد عليه في اختبارات التصدير) لضمان أعلى مستويات الجودة والنقاء.', e: '', img: './img/عسل جنسنج.jpeg'}
  // سوكرادورف/////
];
