const RESTAURANT_SCHEDULE = {
  'Bazooka':            { open: '12:00', close: '3:00' },
  'Karam El Sham':      { open: '12:00', close: '3:00' },
  'B Laban':            { open: '12:00', close: '3:00' },
  'Wahmy Burger':       { open: '12:00', close: '3:00' },
  'Koshary Al Khedewy': { open: '12:00', close: '3:00' },
  'Hawawshi Al Refaie': { open: '12:00', close: '3:00' },
  'Saadaawy Burger':    { open: '12:00', close: '3:00' },
  'Krebs':              { open: '12:00', close: '3:00' },
  'Sliceno':            { open: '12:00', close: '3:00' },
  'Fan w Tarab':        { open: '12:00', close: '3:00' },
  'sokradorf':          { open: '12:00', close: '3:00' },
};
...
const BL={'Bazooka':'بازوكا','Karam El Sham':'كرام الشام','B Laban':'B لبن','Wahmy Burger':'وهمي برجر','Koshary Al Khedewy':'كشري الخديوي','Hawawshi Al Refaie':'حواوشي الرفاعي','Saadaawy Burger':'سعداوي برجر','Krebs':'كريبز','Sliceno':'سلايزينو','Fan w Tarab':'فن وطرب','sokradorf':'سوكرادورف',};
const BRANDS=['Bazooka','Karam El Sham','B Laban','Wahmy Burger','Koshary Al Khedewy','Hawawshi Al Refaie','Saadaawy Burger','Krebs','Sliceno','Fan w Tarab','sokradorf',];
...
// عرض====
 ...
 { id: 768, brand: 'B Laban', n: '  المتكندره حجم اكبر', e:'بلبن', d: 'حلوى', p: 375, img: './img//المتكندره.webp' },
  ...
  { id: 269, brand: 'B Laban', n: 'قشطوطة كراميل', e:'بلبن',   d: 'دنيا القشطوطه', p: 75, img: './img/هبة دبي.jpeg' },
  { id: 270, brand: 'B Laban', n: 'قشطوطة مانجا',  e:'بلبن',  d: 'دنيا القشطوطه', p: 95, img: './img/قشطوطه.jpeg' },
  { id: 271, brand: 'B Laban', n: 'قشطوطة مكسرات', e:'بلبن',  d: 'دنيا القشطوطه', p: 105, img: './img/قشطوطه.jpeg' },
  { id: 272, brand: 'B Laban', n: 'قشطوطة لوتس',   e:'بلبن',    d: 'دنيا القشطوطه', p: 105, img: './img/قشطوطه.jpeg' },
  { id: 273, brand: 'B Laban', n: 'قشطوطة قشطه',   e:'بلبن', d: 'دنيا القشطوطه', p: 75, img: './img/قشطوطه.jpeg' },
  ...
  { id: 295, brand: 'B Laban', n: 'كريب دبي',     e:'بلبن',d: 'كريب دبي',  p: 130, img: './img/كريب مجنم دبي.jpeg' },
  ...
  { id: 343, brand: 'B Laban', n: 'ريمونتادا', e:'بلبن', d: 'حلوى', p: 120, img: './img/ريمونتادا كريم دي لاكريم اللؤه.jpeg' },
  { id: 344, brand: 'B Laban', n: 'كريم دي لا كريم', e:'بلبن', d: 'حلوى', p: 155, img: './img/ريمونتادا كريم دي لاكريم اللؤه.jpeg'},
  { id: 345, brand: 'B Laban', n: 'اللؤة', d: 'حلوى',  e:'بلبن',p: 125, img: './img/ريمونتادا كريم دي لاكريم اللؤه.jpeg' },
...
//  سعداوي= =====
  ...
  // فن وطرب==
  // سوكرادورف/////
{id: 769, brand: 'sokradorf', category: 'بدائل السكر', n: 'سوكرادورف =بديل السكر الابيض', p: 250, d: 'بديل للسكر على شكل نقط تتكون من مادة السكرالوز، العبوة تحتوي على 300 نقطة تكافئ 300 ملعقة سكر ',  img: './img/قطره2.jpeg'},
{id: 770, brand: 'sokradorf', category: 'زبدة المكسرات', n: 'زبدة الفول السوداني الطبيعية', p:105 , d: 'زبدة فول سوداني طبيعية 100% مصنوعة من حبوب الفول السوداني فقط، بدون أي إضافات أو محليات الوزن 300 جرام صافي', img: './img/زبده الفول السوداني.jpeg'},
{id: 771, brand: 'sokradorf', category: 'كريمات المكسرات', n: 'كريمة الفول السوداني بالشوكولاتة', p: 270, d: 'تجمع بين الطعم الغني للفول السوداني وقوامه الكريمي، مع لمسة لذيذة من الشوكولاتة الوزن 300 جرام صافي', img: './img/كريمه فول سوداني شوكلاته.jpeg'},
{id: 772, brand: 'sokradorf', category: 'كريمات المكسرات', n: 'كريمة السمسم', p: 220, d: 'كريمة السمسم الصحية - نفس طعم الحلاوة السبريد بالظبط لكن صحية الوزن 300 جرام صافي',  img: './img/كريمه سمسم.jpeg'},
{id: 773, brand: 'sokradorf', category: 'كريمات المكسرات', n: 'كريمة السمسم بالشوكولاتة', p: 270, d: 'الأولى من نوعها في مصر! تجمع بين النكهة المميزة للسمسم وقوامه الناعم مع لمسة شوكولاتة إسباني الوزن 300 جرام صافي',  img: './img/كريمه سمسم شوكولاته.jpeg'},
{id: 774, brand: 'sokradorf', category: 'زبدة المكسرات', n: 'زبدة الكاجو', p:435 , d: 'مصنوعة من 100% حبوب الكاجو المطحونة فقط بدون أي إضافات أخرى نهائياً الوزن 300 جرام صافي',  img: './img/زبده كاجوا.jpeg'},
{id: 775, brand: 'sokradorf', category: 'زبدة المكسرات', n: 'زبدة الفستق', p: 655, d: 'مصنوعة من 100% فستق مطحون فقط بدون أي زيوت مضافة، بدون سكر، وبدون مواد حافظة الوزن 300 جرام صافي',   img: './img/زبده فستق.jpeg'},
{id: 776, brand: 'sokradorf', category: 'زبدة المكسرات', n: 'زبدة اللوز المحمص', p:395 , d: 'مصنوعة من لوز محمص بعناية ليمنحك طعمًا دافئًا وقوامًا كريميًا ناعمًا الوزن 300 جرام صافي',  img: './img/زبده اللوز.jpeg'},
{id: 777, brand: 'sokradorf', category: 'كريمات المكسرات', n: 'كريمة الفستق', p: 745, d: 'فستق محمص بعناية ليمنحك نكهة طبيعية عميقة وقوامًا كريميًا فاخرًا الوزن 300 جرام صافي',  img: './img/كريمه فستق.jpeg'},
{id: 778, brand: 'sokradorf', category: 'كريمات المكسرات', n: 'كريمة البندق بالشوكولاتة', p:595 , d: 'بندق تركي محمص بعناية مع شوكولاتة إسبانية غنية في كريمة ناعمة الوزن 300 جرام صافي',  img: './img/كريمه بوندق شوكولاته.jpeg'},
{id: 779, brand: 'sokradorf', category: 'كريمات المكسرات', n: 'كريمة البندق', p:545 , d: 'بندق تركي محمص بعناية في كريمة ناعمة بقوام كريمي وطعم لا يُقاوم الوزن 300 جرام صافي',  img: './img/‏‏كريمه بندق - نسخة.jpeg'},
{id: 780, brand: 'sokradorf', category: 'عسل', n: 'عسل زهور الموالح', p: 225, d: 'عسل نحل طبيعي من زهور الموالح (Citrus Honey)، يتميّز برائحته العطرية المنعشة ومذاقه الفريد الذي يجمع بين الحلاوة الخفيفة ولمسة الحمضيات الطبيعية. يُجمع من مصادر موثوقة وخضع لاختبارات دقيقة في معمل Q-CAP التابع لوزارة الزراعة (المعتمد في فحوصات التصدير)، لضمان أعلى مستويات الجودة والنقاء. تم التأكد من: ✅ خلوّه من السكروز ✅ احتوائه على نسبة مياه أقل من 20% ✅ انخفاض قيمة HMF، مما يعني أنه لم يُسخن إطلاقًا للحفاظ على الفيتامينات والمعادن. عسل نقي – مُختبَر – موثوق – بطعم طبيعي منعش غني بالفوائد.', e: '', img: './img/عسل موالح2.jpeg'},
{id: 781, brand: 'sokradorf', category: 'عسل', n: 'عسل سدر', p: 450, d: 'عسل سدر طبيعي فاخر يُعد من أعلى أنواع العسل قيمة غذائية، ويتميّز بتركيز مرتفع من مضادات الأكسدة مقارنة بمعظم أنواع العسل الأخرى. مصدره أشجار السدر، وتم جمعه من مناطق الصعيد، حيث البيئة الطبيعية الأقل تلوثًا، ما ينعكس مباشرة على جودة العسل وقوته. القيمة الأساسية لعسل السدر ترجع إلى مضادات الأكسدة، وهي مركبات تساعد الجسم على مقاومة الشوارد الحرة، وتقليل الإجهاد التأكسدي، ودعم صحة الخلايا والمناعة على المدى الطويل. كلما زادت كثافة العسل ولونه الداكن، دلّ ذلك على ارتفاع محتواه من هذه المركبات النشطة، وهو ما يميّز عسل السدر بشكل واضح. خضع العسل لاختبارات معملية في معمل Q-CAP التابع لوزارة الزراعة، وهو من الجهات المعتمدة التي تُستخدم في فحص منتجات التصدير، لضمان أعلى مستويات الجودة والنقاء. تم التأكد من: ✅ خلوّه من السكروز ✅ احتوائه على نسبة مياه أقل من 20% ✅ انخفاض قيمة HMF، بما يدل على عدم تعرّضه للتسخين والحفاظ على مكوّناته الفعّالة.', e: '', img: './img/عسل سدر2.jpeg'},
{id: 782, brand: 'sokradorf', category: 'عسل', n: 'عسل بالمكسرات', p: 400, d: 'استمتع بمذاق فاخر يجمع بين عسل البرسيم الطبيعي و150 جم من الكاجو واللوز وعين الجمل المحمّص، لتجربة غنية بالطعم والقيمة في كل ملعقة.', e: '', img: './img/عسل مكسرات.jpeg'},
{id: 783, brand: 'sokradorf', category: 'عسل', n: 'عسل حبة البركة', p: 179, d: 'عسل نقي بجودة عالية، يُجمع من رحيق زهور حبة البركة، ليمنحك طعمًا مميزًا وفوائد طبيعية داعمة للمناعة والصحة العامة. منتجاتنا موثوقة خاضعة لاختبارات دقيقة في معمل Q-CAP التابع لوزارة الزراعة (المعتمد في فحوصات التصدير)، لضمان أعلى مستويات الجودة والنقاء. تم التأكد من: ✅ خلوّه من السكروز ✅ احتوائه على نسبة مياه أقل من 20% ✅ انخفاض قيمة HMF، مما يعني أنه لم يُسخن إطلاقًا للحفاظ على الفيتامينات والمعادن. عسل نقي – مُختبَر – موثوق – بطعم طبيعي خفيف يناسب كل يوم.', e: '', img: './img/عسل حبه بركه.jpeg'},
{id: 784, brand: 'sokradorf', category: 'عسل', n: 'عسل زهرة البرسيم', p: 179, d: 'عسل نحل طبيعي من زهور البرسيم (Clover Honey)، يتميّز بطعمه الخفيف ومذاقه المتوازن الذي يناسب جميع الأذواق. منتجاتنا موثوقة خاضعة لاختبارات دقيقة في معمل Q-CAP التابع لوزارة الزراعة (المعتمد في فحوصات التصدير)، لضمان أعلى مستويات الجودة والنقاء. تم التأكد من: ✅ خلوّه من السكروز ✅ احتوائه على نسبة مياه أقل من 20% ✅ انخفاض قيمة HMF، مما يعني أنه لم يُسخن إطلاقًا للحفاظ على الفيتامينات والمعادن. عسل نقي – مُختبَر – موثوق – بطعم طبيعي خفيف يناسب كل يوم.', e: '', img: './img/عسل برسيم.jpeg'},
{id: 785, brand: 'sokradorf', category: 'عسل', n: 'عسل نحل بخلاصة الكركم', p: 300, d: 'عسل طبيعي يُضاف إليه خلاصة الكركم النقية (Turmeric Extract)، المستخلصة من الجزء الفعّال في نبات الكركم، لتعزيز المناعة ودعم صحة المفاصل، خاصة في فصل الشتاء. نستخدم خلاصة مركّزة خالية من الجزيئات الكبيرة غير المرغوبة، لتستفيد من الفوائد الكاملة في كل ملعقة مع الحفاظ على القوام الناعم. خضع لاختبارات في العديد من الجهات الموثوقة أبرزها معمل Q-CAP التابع لوزارة الزراعة (الذي يلجأ له من يريد التصدير) لضمان أعلى مستويات الجودة والنقاء. تم التأكد من: ✅ خلوّه من السكروز ✅ احتوائه على نسبة مياه أقل من 20% ✅ انخفاض قيمة HMF، مما يعني أنه لم يُسخن إطلاقًا للحفاظ على الفيتامينات والمعادن. منتج طبيعي – مُختبَر – موثوق – غني بالفوائد.', e: '', img: './img/عسل كركم 4.webp'},
{id: 786, brand: 'sokradorf', category: 'عسل', n: 'عسل نحل بخلاصة الجنسنغ', p: 300, d: 'عسل طبيعي يُضاف إليه خلاصة الجنسنغ النقية (Ginseng Extract)، المستخلصة من الجزء الفعّال في نبات الجنسنغ، لدعم الطاقة والتركيز وتعزيز الحيوية بشكل طبيعي. نستخدم خلاصة مركّزة خالية من الجزيئات الكبيرة غير المرغوبة، لتستفيد من الفوائد الكاملة في كل ملعقة مع الحفاظ على القوام الناعم والطعم الغني. خضع لاختبارات في العديد من الجهات الموثوقة، أبرزها معمل Q-CAP التابع لوزارة الزراعة (الذي يُعتمد عليه في اختبارات التصدير) لضمان أعلى مستويات الجودة والنقاء.', e: '', img: './img/عسل جنسنج.jpeg'}
  // سوكرادورف/////
];
